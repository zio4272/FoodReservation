package kr.co.tjeit.foodreservation.util;
...
import kr.co.tjeit.foodreservation.MainActivity;
...
public class GpsInfo extends Service implements LocationListener {
    ...
    public void showSettingsAlert() {
        ...
        alertDialog.setTitle("위치 확인");
        alertDialog.setMessage("사용자의 위치가 확인되지 않습니다.\nGPS 설정을 ON 해주세요.");
